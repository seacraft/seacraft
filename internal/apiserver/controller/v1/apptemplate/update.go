...
// Update update a  application template  by the id  identifier.
func (a *AppTemplateController) Update(c *gin.Context) {
	log.L(c).Info("update app template function called.")
	var r msg.UpdateAppTemplateRequest
	...
	r.Id = id
	if err := a.srv.AppTemplates().Update(c, &r, metav1.UpdateOptions{}); err != nil {
